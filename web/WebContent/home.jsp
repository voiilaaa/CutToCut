      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-12">
          ...
          <div class="small-box bg-green">
            ...
            <a href="booking.jsp" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
		<div class="col-lg-3 col-xs-12">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="regisList.jsp" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
      </div>
      <!-- /.row -->
