...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Registrasi List
        <small>DataTable Registrasi</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="adminside.html"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Registrasi List</li>
      </ol>
    </section>
...
<script>
  $(function () {
    ...
    { "orderable": false, "searchable": false, "defaultContent": "<button class='btn btn-block btn-danger'>Delete</button>"}
  ]
...
<script>
 ...
 function delete_booking(){
   ...
   firebase.database().ref().child('/registrasi/' + booking_id).remove();
   reload_page();
  }
 </script>
</body>
